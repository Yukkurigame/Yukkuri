...
char list_is_full(objl_list *listo)
{
	return(listo->item_count == listo->current_max_size);
}

void list_grow(objl_list *old_listo)
{
	int i;
	objl_list new_listo;
...
void list_make(objl_list *listo, int start_size, char growable)
{
...
void* list_get_name(objl_list *listo, char *name_to_find)
{
	int i = 0;
