...
#include "3rdparty/objTester/list.h"
...
//	vector extreme_dimensions[2];
	...
	objl_list vertex_list;
	objl_list vertex_normal_list;
	objl_list vertex_texture_list;

	objl_list face_list;
	objl_list sphere_list;
	objl_list plane_list;

	objl_list light_point_list;
	objl_list light_quad_list;
	objl_list light_disc_list;

	objl_list material_list;
